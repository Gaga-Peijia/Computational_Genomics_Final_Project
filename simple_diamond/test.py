...
"""
# Example usage
query_seq = "PALADINPALADINPALADINPALADINPALADINPALADINPALADINPALADINPALADIN"
ref_seq = "PALADIMPALADINPALADINPALADINPALADINPALADINPALADINPALADINPALADIN"
print(len(query_seq))
seed_start_pos1 = 45  # Example start position of the seed in query_seq
seed_start_pos2 = 45  # Example start position of the seed in ref_seq
