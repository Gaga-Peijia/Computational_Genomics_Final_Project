...
sorted_query_reduced, sorted_protein_database_reduced = double_indexing.double_indexing_iterator(query_dictionary_reduced, protein_database_dictionary_reduced)
